...
#     # TTS 설정 (ElevenLabs) - 공백 제거!
#     ELEVENLABS_API_KEY = os.getenv("ELEVENLABS_API_KEY", "").strip()
#     TTS_VOICE_ID = os.getenv("TTS_VOICE_ID", "uyVNoMrnUku1dZyVEXwD").strip()  # 공백 제거
#     TTS_MODEL = os.getenv("TTS_MODEL", "eleven_flash_v2_5").strip()
#     TTS_OPTIMIZE_LATENCY = int(os.getenv("TTS_OPTIMIZE_LATENCY", "1"))
...
class Settings:
    ...
    # TTS 설정 (ElevenLabs) - 임시로 하드코딩
    ELEVENLABS_API_KEY = os.getenv("ELEVENLABS_API_KEY", "").strip()
    
    # 하드코딩으로 강제 설정 (환경변수 무시)
    TTS_VOICE_ID = "uyVNoMrnUku1dZyVEXwD"  # Adam voice
